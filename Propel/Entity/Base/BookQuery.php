...
use ANSR\Propel\Entity\Map\BookTableMap;
 ...
 *
 * @method     \ANSR\Propel\Entity\PublisherQuery|\ANSR\Propel\Entity\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ANSR\Propel\Entity\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\ANSR\\Propel\\Entity\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \ANSR\Propel\Entity\Publisher object
     *
     * @param \ANSR\Propel\Entity\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($publisher instanceof \ANSR\Propel\Entity\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \ANSR\Propel\Entity\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ANSR\Propel\Entity\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\ANSR\Propel\Entity\PublisherQuery');
    }

    /**
     * Filter the query by a related \ANSR\Propel\Entity\Author object
     *
     * @param \ANSR\Propel\Entity\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($author instanceof \ANSR\Propel\Entity\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \ANSR\Propel\Entity\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ANSR\Propel\Entity\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\ANSR\Propel\Entity\AuthorQuery');
    }
