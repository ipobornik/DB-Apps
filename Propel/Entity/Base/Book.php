...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ANSR\\Propel\\Entity\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of ANSR\Propel\Entity\Base\Book object.
     */
     ...
     * @return $this|\ANSR\Propel\Entity\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ANSR\\Propel\\Entity\\Book'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ANSR\Propel\Entity\Book
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ANSR\Propel\Entity\Book The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ANSR\Propel\Entity\Book (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ANSR\Propel\Entity\Book Clone of current object.
     * @throws PropelException
     */
