...
use ANSR\Propel\Entity\Publisher;
use ANSR\Propel\Entity\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ANSR.Propel.Entity.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\ANSR\\Propel\\Entity\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ANSR.Propel.Entity.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ANSR\\Propel\\Entity\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\ANSR\\Propel\\Entity\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ANSR\Propel\Entity\Publisher) { // it's a model object
